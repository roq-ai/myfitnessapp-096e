...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Health Plan.create': { roles: ['owner'], key: 'create', tenantPath: [], userPath: [] },
  'Report.create': { roles: ['owner', 'health-coach'], key: 'create', tenantPath: [], userPath: [] },
  'Health Plan.update': { roles: ['health-coach', 'admin'], key: 'update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'health-coach', 'admin'];
