...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`MyFitnessApp`}</title>

        <meta
          name="description"
          content="Welcome to MyFitnessApp, your ultimate partner in health management. Tracking your health and reminding you to exercise, we're committed to your wellness journey."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1679679008578-e3b6406bdb47?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxoZWFsdGh8ZW58MHx8fHwxNjk1NjEzNDcyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MyFitnessApp, your ultimate partner in health management. Tracking your health and reminding you to exercise, we're committed to your wellness journey.`}
            </Text>
            <Box
